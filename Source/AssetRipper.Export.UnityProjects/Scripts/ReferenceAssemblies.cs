...
public static partial class ReferenceAssemblies
{
	...
	private static readonly Dictionary<string, UnityExtensionAssembly> UnityExtensionAssemblies =
		new Dictionary<string, UnityExtensionAssembly>() {		
			...
			{"PerformanceTesting",new UnityExtensionAssembly(new UnityGuid(0xBB836ED0, 0x8024F66B, 0xAE06BFBA, 0x423040E8), new UnityVersion(2017), new UnityVersion(2019))},
			...
			{"Advertisements",new UnityExtensionAssembly(new UnityGuid(0xF9DBB937, 0x8624B463, 0x8DF9F478, 0xFEEB3BA6), new UnityVersion(5), new UnityVersion(2017))},
			{"Analytics",new UnityExtensionAssembly(new UnityGuid(0x0865E258, 0x36149BE2, 0x194BBCA8, 0x0B794418), new UnityVersion(5), new UnityVersion(2017))},
			{"Purchasing",new UnityExtensionAssembly(new UnityGuid(0xDE8DC0E8, 0xC2144D44, 0x602460EB, 0x44E9CBA7), new UnityVersion(5), new UnityVersion(2017))},
			{"VR",new UnityExtensionAssembly(new UnityGuid(0xC5E1FDC6, 0x02741D87, 0x4DCCDAAA, 0x69FD297C), new UnityVersion(5), new UnityVersion(2017))},
	};
